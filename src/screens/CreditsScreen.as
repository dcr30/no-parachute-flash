package screens 
{
	...
	public class CreditsScreen extends Screen
	{
		...
		override public function init(params:Object = null):void 
		{
			...
			currentLevelName.text = "No Parachute!\n\n\nProgramming: Nikita Bredikhin\nArt: Nikita Bredikhin\nbredikhin.nikita@gmail.com\n\nMusic: «Long Time Coming» by Kevin MacLeod\n(incompetech.com)";
		...
		{
			Instances.main.changeScreen(MainMenuScreen);
		}
